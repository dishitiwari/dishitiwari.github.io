...
if ($result1->num_rows > 0) 
{
 ...
 switch($Edit_type)                                        /*editing student details acc to edit_type*/
 {
  case 'firstname':                                        //to edit firstname
	 ...
	 {
	 $i=$_POST['fn'];
	 $sql2="UPDATE alumni SET Fname='$i' WHERE Emailid='$j' ";                   //
	 }
    break;
  case 'lastname':                                        //to edit LASTNAME
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET Lname='$i'  WHERE Emailid='$j'";
	 }
    break;
    ...
    echo '</select></p>
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET BATCH='$i' WHERE Emailid='$j'";
	 }
    break;
    ...
    echo'</select></p><p><input type="submit" id="submit" name="submit" value="UPDATE"</p>
	 ...
	 {
	 $p=$_POST['edit1'];
	 $sql2="UPDATE alumni SET DD='$p'  WHERE Emailid='$j'";
	 }
	  if(isset($_POST['edit2']))
	 {
	 $q=$_POST['edit2'];
	 $sql3="UPDATE alumni SET MM='$q'  WHERE Emailid='$j'";
	 }
	 
	 if(isset($_POST['edit3']))
	 {
	 $r=$_POST['edit3'];
	 $sql4="UPDATE alumni SET YY='$r' WHERE Emailid='$j'";
	 }
    break;
  ...
  case 'city':                                        //to edit city
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET CITY='$i' WHERE Emailid='$j'";
	 }
    break;
	case 'mobileno':                                        //to edit mobileno
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET MOBILENO=$i WHERE Emailid='$j'";
	 }
    break;
	case 'address':                                        //to edit address
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET ADDRESS='$i' WHERE Emailid='$j'";
	 }
    break;
	case 'presentstatus':                                        //to edit presentstatus
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET PRESENTST='$i' WHERE Emailid='$j'";
	 }
    break;
	...
	case 'college':                                        //to edit college
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET COLLEGE='$i' WHERE Emailid='$j'";
	 }
    break;
	...
	case 'degree':                                        //to edit degree
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET DEGREE='$i' WHERE Emailid='$j'";
	 }
    break;
	...
	case 'stream':                                        //to edit stream
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET STREAM='$i' WHERE Emailid='$j'";
	 }
    break;
	case 'sem':                                        //to edit sem
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET SEM='$i' WHERE Emailid='$j'";
	 }
    break;
	...
	case 'year':                                        //to edit year
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET YR=$i WHERE Emailid='$j'";
	 }
    break;
	case 'org':                                        //to edit org
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET ORG='$i' WHERE Emailid='$j'";
	 }
    break;
	case 'designation':                                        //to edit designation
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET designation='$i' WHERE Emailid='$j'";
	 }
    break;
	case 'officeaddress':                                        //to edit officeaddress
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET OFFADDRESS='$i' WHERE Emailid='$j'";
	 }
    break;
	case 'salary':                                        //to edit salary
	 ...
	 {
	 $i=$_POST['edit'];
	 $sql2="UPDATE alumni SET SALARY='$i' WHERE Emailid='$j'";
	 }
    break;
